...
describe 'As a logged in user' do
  describe "When I visit '/dashboard'" do
    it "should see a list of all bookmarked segments under the Bookmarked Segments section\n
      And they should be organized by which tutorial they are a part of\n
      And the videos should be ordered by their position" do
      user = create(:user)
      ...
      pre_vid_1 = prework_tutorial.videos.create!({
      ...
      pre_vid_2 = prework_tutorial.videos.create!({
      ...
      pre_vid_3 = prework_tutorial.videos.create!({
      ...
      pre_vid_4 = prework_tutorial.videos.create!({
      ...
      m1_vid_1 = m1_tutorial.videos.create!({
      ...
      m1_vid_2 = m1_tutorial.videos.create!({
      ...
      m3_vid_1 = m3_tutorial.videos.create!({
      ...
      m3_vid_2 = m3_tutorial.videos.create!({
      ...
      m3_vid_3 = m3_tutorial.videos.create!({
      ...
      m3_vid_4 = m3_tutorial.videos.create!({
      ...
      m3_vid_5 = m3_tutorial.videos.create!({
      ...
      m3_vid_6 = m3_tutorial.videos.create!({
      ...
      bookmark_1 = UserVideo.create(user_id: user.id, video_id: pre_vid_1.id)
      bookmark_1 = UserVideo.create(user_id: user.id, video_id: m1_vid_1.id)
      bookmark_1 = UserVideo.create(user_id: user.id, video_id: m3_vid_1.id)
